...
impl FontInputFormat
{
	...
	fn process(&self, resourceRelativeUrl: &str, configuration: &Configuration, inputContentFilePath: &Path, handlebars: &mut Handlebars, headerTemplates: &HashMap<String, String>, ifLanguageAwareLanguageData: Option<&LanguageData>, languageData: &LanguageData, max_age_in_seconds: u32, is_downloadable: bool, utf8_xml_metadata: &[u8], woff1_private_data: &[u8], woff1_iterations: u16, woff2_brotli_quality: u8, woff2_disallow_transforms: bool, include_ttf: bool) -> Result<Vec<(Url, HashMap<UrlTag, Rc<JsonValue>>, ContentType, Vec<(String, String)>, Vec<u8>, Option<(Vec<(String, String)>, Vec<u8>)>, bool)>, CordialError>
	{
		...
		// woff
		{
			...
			let woffUrl = languageData.url(&Pipeline::replaceFileNameExtension(resourceRelativeUrl, ".woff2"))?;
			...
			urls.push((woffUrl, hashmap! { default => Rc::new(JsonValue::Null) }, ContentType(Pipeline::mimeType("font/woff")), woffHeaders, woffBody, None, canBeCompressed));
		}
		...
		// woff2
		{
			...
			let woff2Url = languageData.url(&Pipeline::replaceFileNameExtension(resourceRelativeUrl, ".woff2"))?;
			...
			urls.push((woff2Url, hashmap! { default => Rc::new(JsonValue::Null) }, ContentType(Pipeline::mimeType("font/woff2")), woff2Headers, woff2Body, None, canBeCompressed));
		}
		...
		if include_ttf
		{
			...
			urls.push((ttfUrl, hashmap! { default => Rc::new(JsonValue::Null) }, ContentType(Pipeline::mimeType("application/font-sfnt")), ttfHeaders, ttfBytes, None, canBeCompressed));
		}
